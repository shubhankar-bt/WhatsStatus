package com.shubhankarsudip.whatsappstatussaver.Fragments;
...
import com.shubhankarsudip.whatsappstatussaver.Adapter.ImageAdapter;
...
public class ImageFragment extends Fragment {
    ...
    private void getStatus() {
        ...
        if (Common.STATUS_DIRECTORY.exists()) {
            ...
            Toast.makeText(getActivity(), "No Whatsapp Files Exists", Toast.LENGTH_SHORT).show();
